    ...
    $(document).ready(
        function() {
            ...
            var colors = new Array(
                [5, 4, 10], [33, 28, 66], [60, 51, 121], [88, 74, 176], [99, 86, 184], [238, 68, 55]);
                ...
                if (dataString == "") {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            ...
                            var msgSuccess;
                            msgSuccess = $('<div class="merci">Merci ' + nom + ', votre message a bien ̩t̩ envoy̩ </div>');
                        ...
                        error: function() {
                            var msgError;
                            msgError = $('<div class="echec">Le message n\'a pas ̩t̩ envoy̩ </div>');
